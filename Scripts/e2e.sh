...
/usr/bin/plutil -lint "$APP_DIR/Contents/Library/LaunchDaemons/com.local.lidkeepawake.helper.plist"
/usr/bin/codesign --verify --deep --strict "$APP_DIR"

echo
echo "Bundle checks passed. Physical lid testing is manual."
echo "Open with: open '$APP_DIR'"
echo "The first toggle installs the helper and asks for an administrator password."
echo "Then test AC and battery behavior, and verify with: pmset -g"
